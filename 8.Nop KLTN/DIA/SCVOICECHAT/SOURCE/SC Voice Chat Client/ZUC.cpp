...
void CZUC::ZUC(u8* k, u8* iv, u32* ks, int len)
{
...
void CZUC::ZUCNext( u32* ks, int len)
{
	/*  The procedure of generating keystream of ZUC, see page 18 of ref. [3]*/
	GenerateKeystream(ks, len);
}
void CZUC::EEA3(u8* CK,u32 COUNT,u32 BEARER,u32 DIRECTION,u32 LENGTH,u32* M,u32* C)
{
	u32 *z, L, i;
	u8 	IV[16];
...
void CZUC::EEA3Next(u32 LENGTH,u32* M,u32* C)
{
	u32 *z, L, i;
...
void CZUC::LFSRWithInitialisationMode(u32 u)
{
	u32 f, v;
	f = LFSR_S0;
...
/* initialize */
void CZUC::Initialization(u8* k, u8* iv)
{
	u32 w, nCount;
	/* expand key */
...
void CZUC::GenerateKeystream(u32* pKeystream, int KeystreamLen)
{
	int i;
	{
		BitReorganization();
...
void CZUC::MakeKeystream(u8* CK,u32 COUNT,u32 BEARER,u32 DIRECTION,u32 LENGTH,u32* Keystream)
{
	u32  L, i;
	u8 	IV[16];
	...
	ZUC(CK,IV,Keystream,L);
}
void CZUC::MakeNextKeystream(u32 LENGTH,u32* Keystream)
{
	
	u32  L;
	L 	= (LENGTH+31)/32;
	GenerateKeystream( Keystream, L);
}